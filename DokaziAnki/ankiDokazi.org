...
Ko gre \(  n \to \infty \), gre \(  \phi_n \to \phi \)
...
\[ \left| \phi_n - \phi \right| = \left| \phi_n - \lim_{m \to \infty} \phi_m  \right| = \lim_{m \to \infty} \left| \phi_n - \phi_m \right| < \frac{\epsilon}{2}
\]
